...
Print a human-readable overview of each record return in the results
from a call to [`npi_search`](npi_search.md). The format of the summary
is modeled after the one offered on the NPI registry website.
